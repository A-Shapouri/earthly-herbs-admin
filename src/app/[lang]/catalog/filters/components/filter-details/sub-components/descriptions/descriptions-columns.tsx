...
import filterDescriptionDeleteApi, { FilterDescriptionDeleteProps } from '@api/filters/description-delete';
  ...
  },
  {
    ...
    cell: (info) => {
      const {
        ...
        getCallbackData: (props: FilterDescriptionDeleteProps) => filterDescriptionDeleteApi({ ...props }),
        apiMessageText: 'Store Succeeded',
        apiMessageDescription: 'A Filter Description has been deleted successfully.',
      });
