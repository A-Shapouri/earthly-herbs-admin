...
import manufacturersDeleteApi, { ManufacturersDeleteProps } from '@api/manufacturers/delete';
...
import { header, columns } from './manufacturers-columns';
...
const Manufacturers = () => {
  ...
  const {
    ...
    getCallbackData: (props: ManufacturersListProps) => manufacturersListApi({ ...props }),
  });
  const {
    setData,
    loading: deleteLoading,
  } = useUpdate({
    getCallbackData: (props: ManufacturersDeleteProps) => manufacturersDeleteApi({ ...props }),
    apiMessageText: 'Delete Succeeded',
    apiMessageDescription: 'The Manufacturer has been Deleted Successfully.',
  });
  ...
  return (
    <Div className={'flex-col justify-center w-full gap-4 md:gap-8'}>
      <Div className={'flex-col sm:flex-row w-full justify-between gap-4'}>
        ...
        />
        <Text type={'bold'} typography={['xl', 'xl']} align={'start'}>Manufacturer</Text>
      </Div>
