...
import { columns, Shipment, header } from './shipments-columns';
import { ColumnDef } from '@tanstack/react-table';
import Text from '@elements/text';
import { CatalogFormProps } from '@modules/catalog-form/catalog-form';
import { ShipmentType } from './store';

const Shipments = ({ languageData, loading, moduleForm, searchLanguage } : {languageData: Array<any>, loading: boolean, moduleForm: CatalogFormProps<ShipmentType>, searchLanguage: (searchText: string) => void}) => {
  const dynamicColumns: ColumnDef<Shipment>[] = [
    {
