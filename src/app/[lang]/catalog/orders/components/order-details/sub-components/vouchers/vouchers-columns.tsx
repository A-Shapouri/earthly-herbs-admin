...
import orderVoucherDeleteApi, { OrderVoucherDeleteProps } from '@api/orders/vouchers-delete';
  ...
  },
  {
    ...
    cell: (info) => {
      const {
        ...
        getCallbackData: (props: OrderVoucherDeleteProps) => orderVoucherDeleteApi({ ...props }),
        apiMessageText: 'Store Succeeded',
        apiMessageDescription: 'A Order Voucher has been deleted successfully.',
      });
