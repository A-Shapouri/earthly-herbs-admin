...
import orderStatusDeleteApi, { OrderStatusDeleteProps } from '@api/orders/status-delete';
  ...
  },
  {
    ...
    cell: (info) => {
      const {
        ...
        getCallbackData: (props: OrderStatusDeleteProps) => orderStatusDeleteApi({ ...props }),
        apiMessageText: 'Store Succeeded',
        apiMessageDescription: 'A Order Status has been deleted successfully.',
      });
