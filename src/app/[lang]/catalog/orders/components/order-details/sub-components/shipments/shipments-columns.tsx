...
import orderShipmentDeleteApi, { OrderShipmentDeleteProps } from '@api/orders/shipments-delete';
  ...
  },
  {
    ...
    cell: (info) => {
      const {
        ...
        getCallbackData: (props: OrderShipmentDeleteProps) => orderShipmentDeleteApi({ ...props }),
        apiMessageText: 'Store Succeeded',
        apiMessageDescription: 'A Order Shipment has been deleted successfully.',
      });
