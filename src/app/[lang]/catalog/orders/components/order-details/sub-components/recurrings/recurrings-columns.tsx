...
import orderRecurringDeleteApi, { OrderRecurringDeleteProps } from '@api/orders/recurrings-delete';
  ...
  },
  {
    ...
    cell: (info) => {
      const {
        ...
        getCallbackData: (props: OrderRecurringDeleteProps) => orderRecurringDeleteApi({ ...props }),
        apiMessageText: 'Store Succeeded',
        apiMessageDescription: 'A Order Recurring has been deleted successfully.',
      });
