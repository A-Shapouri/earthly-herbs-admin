...
import { columns, Option, header } from './options-columns';
import { ColumnDef } from '@tanstack/react-table';
import Text from '@elements/text';
import { CatalogFormProps } from '@modules/catalog-form/catalog-form';
import { OptionType } from './store';

const Options = ({ languageData, loading, moduleForm, searchLanguage } : {languageData: Array<any>, loading: boolean, moduleForm: CatalogFormProps<OptionType>, searchLanguage: (searchText: string) => void}) => {
  const dynamicColumns: ColumnDef<Option>[] = [
    {
