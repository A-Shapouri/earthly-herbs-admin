...
import orderOptionDeleteApi, { OrderOptionDeleteProps } from '@api/orders/options-delete';
  ...
  },
  {
    ...
    cell: (info) => {
      const {
        ...
        getCallbackData: (props: OrderOptionDeleteProps) => orderOptionDeleteApi({ ...props }),
        apiMessageText: 'Store Succeeded',
        apiMessageDescription: 'A Order Option has been deleted successfully.',
      });
