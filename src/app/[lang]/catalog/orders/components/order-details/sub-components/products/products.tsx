...
import { columns, Product, header } from './products-columns';
import { ColumnDef } from '@tanstack/react-table';
import Text from '@elements/text';
import { CatalogFormProps } from '@modules/catalog-form/catalog-form';
import { ProductType } from './store';

const Products = ({ languageData, loading, moduleForm, searchLanguage } : {languageData: Array<any>, loading: boolean, moduleForm: CatalogFormProps<ProductType>, searchLanguage: (searchText: string) => void}) => {
