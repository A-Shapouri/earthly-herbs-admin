...
import { columns, Recurring, header } from './recurrings-columns';
import { ColumnDef } from '@tanstack/react-table';
import Text from '@elements/text';
import { CatalogFormProps } from '@modules/catalog-form/catalog-form';
import { RecurringType } from './store';

const Recurrings = ({ languageData, loading, moduleForm, searchLanguage } : {languageData: Array<any>, loading: boolean, moduleForm: CatalogFormProps<RecurringType>, searchLanguage: (searchText: string) => void}) => {
  const dynamicColumns: ColumnDef<Recurring>[] = [
    {
