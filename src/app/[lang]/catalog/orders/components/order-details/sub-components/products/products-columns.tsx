...
import orderProductDeleteApi, { OrderProductDeleteProps } from '@api/orders/products-delete';
  ...
  },
  {
    ...
    cell: (info) => {
      const {
        ...
        getCallbackData: (props: OrderProductDeleteProps) => orderProductDeleteApi({ ...props }),
        apiMessageText: 'Store Succeeded',
        apiMessageDescription: 'A Order Product has been deleted successfully.',
      });
