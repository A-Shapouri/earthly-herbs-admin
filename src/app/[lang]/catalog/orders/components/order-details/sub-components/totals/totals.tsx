...
import { columns, Total, header } from './totals-columns';
import { ColumnDef } from '@tanstack/react-table';
import Text from '@elements/text';
import { CatalogFormProps } from '@modules/catalog-form/catalog-form';
import { TotalType } from './store';

const Totals = ({ languageData, loading, moduleForm, searchLanguage } : {languageData: Array<any>, loading: boolean, moduleForm: CatalogFormProps<TotalType>, searchLanguage: (searchText: string) => void}) => {
  const dynamicColumns: ColumnDef<Total>[] = [
    {
