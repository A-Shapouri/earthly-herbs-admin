...
import { columns, Status, header } from './statuses-columns';
import { ColumnDef } from '@tanstack/react-table';
import Text from '@elements/text';
import { CatalogFormProps } from '@modules/catalog-form/catalog-form';
import { StatusType } from './store';

const Statuses = ({ languageData, loading, moduleForm, searchLanguage } : {languageData: Array<any>, loading: boolean, moduleForm: CatalogFormProps<StatusType>, searchLanguage: (searchText: string) => void}) => {
  const dynamicColumns: ColumnDef<Status>[] = [
    {
