...
import orderTotalDeleteApi, { OrderTotalDeleteProps } from '@api/orders/totals-delete';
...
export const columns: ColumnDef<Total>[] = [
  {
  ...
  },
  {
    ...
    cell: (info) => {
      const {
        ...
        getCallbackData: (props: OrderTotalDeleteProps) => orderTotalDeleteApi({ ...props }),
        apiMessageText: 'Store Succeeded',
        apiMessageDescription: 'A Order Total has been deleted successfully.',
      });
