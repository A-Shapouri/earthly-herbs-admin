...
import { columns, History, header } from './histories-columns';
import { ColumnDef } from '@tanstack/react-table';
import Text from '@elements/text';
import { CatalogFormProps } from '@modules/catalog-form/catalog-form';
import { HistoryType } from './store';

const Histories = ({ languageData, loading, moduleForm, searchLanguage } : {languageData: Array<any>, loading: boolean, moduleForm: CatalogFormProps<HistoryType>, searchLanguage: (searchText: string) => void}) => {
  const dynamicColumns: ColumnDef<History>[] = [
    {
