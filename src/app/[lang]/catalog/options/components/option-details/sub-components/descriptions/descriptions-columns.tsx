...
import optionDescriptionDeleteApi, { OptionDescriptionDeleteProps } from '@api/options/description-delete';
  ...
  },
  {
    ...
    cell: (info) => {
      const {
        ...
        getCallbackData: (props: OptionDescriptionDeleteProps) => optionDescriptionDeleteApi({ ...props }),
        apiMessageText: 'Store Succeeded',
        apiMessageDescription: 'A Option Description has been deleted successfully.',
      });
