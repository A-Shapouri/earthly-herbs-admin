...
import { header, columns } from './options-columns';
...
const Options = () => {
  ...
  const {
    ...
    getCallbackData: (props: OptionsListProps) => optionsListApi({ ...props }),
  });
  const {
    setData,
    ...
    apiMessageDescription: 'The Option has been Deleted Successfully.',
  });
