...
export const header = {
  name: 'Name',
  attributeGroupId: 'Attribute Group',
...
export const columns: ColumnDef<Attribute>[] = [
  ...
  {
    accessorFn: row => row.attributeGroupId,
    header: header.attributeGroupId,
    id: 'attributeGroupId',
    cell: info => <Text typography={['xs', 'xs']}>{info.row.original.attributeGroupId}</Text>,
  },
  {
