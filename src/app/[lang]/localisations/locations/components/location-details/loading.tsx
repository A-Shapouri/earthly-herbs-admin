    ...
    <Div className={'w-full gap-6 grid md:grid-cols-3 md:grid-rows-3 grid-cols-1 mt-4 grid-flow-dense'}>
      <MainSection className='md:row-span-1 md:col-span-2' title='Primary Details'>
        ...
        <Skeleton
          size={'small'}
          color={'slate'}
          className={'max-w-full min-w-full md:max-w-full md:min-w-full p-0 md:col-span-5 min-h-24'} />
        <Skeleton
          size={'small'}
          color={'slate'}
          className={'max-w-full min-w-full md:max-w-full md:min-w-full p-0 md:col-span-2'} />
        <Skeleton
          size={'small'}
          color={'slate'}
          className={'max-w-full min-w-full md:max-w-full md:min-w-full p-0 md:col-span-2'} />
      ...
      <MainSection className='md:row-span-1 md:col-span-2' title='Primary Details'>
        <Skeleton
          size={'small'}
          color={'slate'}
          className={'max-w-full min-w-full md:max-w-full md:min-w-full p-0 md:col-span-4 min-h-24'} />
        <Skeleton
          size={'small'}
          color={'slate'}
          className={'max-w-full min-w-full md:max-w-full md:min-w-full p-0 md:col-span-6 min-h-24'} />
      </MainSection>
