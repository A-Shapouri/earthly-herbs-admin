...
import CatalogIcon from '@icons-components/catalog';
...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: '#',
        children: [
          { label: 'Category', route: routes['route.catalog.category.index'] },
        ],
      },
    ],
  },
        ...
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          ...
          <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
            {menuGroups.map((group, groupIndex) => (
              <Div className='w-full gap-4 flex-col' key={groupIndex}>
                <Text type='bold' color={'frost'}>
                  {group.name}
                </Text>
